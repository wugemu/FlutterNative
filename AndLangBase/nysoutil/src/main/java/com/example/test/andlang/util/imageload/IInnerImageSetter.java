...
public interface IInnerImageSetter {
    ...
    <IMAGE extends ImageView> void doLoadImageRound(@NonNull IMAGE view, @Nullable String url, int backRes);
    <IMAGE extends ImageView> void doLoadImageRound(@NonNull IMAGE view, @Nullable String url, float round,int backRes);
    <IMAGE extends ImageView> void doLoadImageRound(@NonNull IMAGE view, @Nullable String url,int width,int height, float round);
    <IMAGE extends ImageView> void doLoadImageRound(@NonNull IMAGE view, @Nullable String url, BitmapFillet.CornerType cornerType,int width,int height, float round);
}
