...
public class PreferencesUtil {
	...
	public static String PREFERENCES_DEFAULT = "andlang";
	public static boolean useMMKV=true;

	public PreferencesUtil(Context context, String file) {
		if(useMMKV) {
			sharedPreferences = MMKV.mmkvWithID(file, Context.MODE_PRIVATE);
		}else {
	...
	public static SharedPreferences getPreferences(Context context) {
		if(useMMKV) {
			sharedPreferences = MMKV.mmkvWithID(PREFERENCES_DEFAULT, Context.MODE_PRIVATE);
		}else {
